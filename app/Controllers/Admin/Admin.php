...
class Admin
{
    ...
    public static function mergeOmnibusMessageWithDiscountRule($message, $price, $price_lowest) {
        ...
        return apply_filters('wdr_omnibus_directive_message_for_omnibus', $message, $min_price, $lowest_price_date);
    }
    ...
    public static function separateOmnibusMessageForDiscountRule() {
        ...
        $message = apply_filters('wdr_omnibus_directive_message', $message, $min_price, $lowest_price_date);
        ...
        if(isset($_POST['wdr-od-submit'])) {
            if (wp_verify_nonce($_POST['wdr_od_nonce_name'], 'wdr_od_nonce_action')) {
                ...
                $settings_data = [
                    ...
                    'message' => self::$helper->checkMessageTags(isset($message) ? trim($message) : null),
