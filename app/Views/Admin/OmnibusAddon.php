                ...
                <tr class="hide_table_position" id="wdr_od_select_message_position" style="<?php echo empty($is_show_omnibus_message_option) || !empty($is_override_omnibus_message) ? 'display:none' : ''; ?>" >
                    ...
                    <td>
                        <select name="wdr_od_position_to_show_message">
                            <option value="woocommerce_get_price_html" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_get_price_html' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce get price html', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_single_product_summary" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_single_product_summary' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce single product summary', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_before_add_to_cart_form" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_before_add_to_cart_form' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce before add to cart form', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_product_meta_end" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_product_meta_end' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce product meta end', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_product_meta_start" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_product_meta_start' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce product meta start', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_before_add_to_cart_button" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_before_add_to_cart_button' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce before add to cart button', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_after_add_to_cart_quantity" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_after_add_to_cart_quantity' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce after add to cart quantity', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_after_add_to_cart_form" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_after_add_to_cart_form' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce after add to cart form', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_after_single_product" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_after_single_product' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce after single product', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_before_single_product" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_before_single_product' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce before single product', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_after_single_product_summary" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_after_single_product_summary' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce after single product summary', 'wdr-omnibus-directive'); ?></option>
                            <option value="woocommerce_before_single_product_summary" <?php echo isset($position_to_show_message) && $position_to_show_message == 'woocommerce_before_single_product_summary' ? 'selected' : ''; ?>><?php esc_attr_e('WooCommerce before single product summary', 'wdr-omnibus-directive'); ?></option>
                        </select>
                    </td>
                </tr>
                </tbody>
